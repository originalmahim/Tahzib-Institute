...
function UpdatePassword({darkTheme}) {
    ...
    <div className="sec-background grid min-h-[calc(100vh-3.5rem)] place-items-center">
      {loading ? (
        ...
        <div className="sec-background max-w-[500px] p-4 lg:p-8">
          ...
          <p className="my-4 text-[1.125rem] leading-[1.625rem] primary-text">
          ...
          <form onSubmit={handleOnSubmit}>
            <label className="relative">
              ...
              <input
                ...
                className="w-full rounded-[0.5rem] bg-transparent p-[12px] primary-text border-2 ring-1 "
              />
              <span
