...
export default function DeleteAccount() {
  ...
  return (
    <>
      <div className="my-10 flex flex-row gap-x-5 rounded-md border-[1px] border-[#04a799] bg-[#04a799] p-8 px-6 sm:px-12">
        <div className="flex aspect-square h-14 w-14 items-center justify-center rounded-full bg-red-600">
          <FiTrash2 className="text-3xl text-pink-200" />
        </div>

        <div className="flex flex-col ">
          <h2 className="text-lg font-semibold primary-text "> Delete Account</h2>

          <div className="sm:w-3/5 primary-text flex flex-col gap-3 mt-1">
